namespace Facturacion.Front.Services
{
    using Facturacion.Front.SunatProduccion;
    using System;
    ...
    public class ConexionSunat : IDisposable
    {
        ...
        public ConexionSunat(string ruc, string username, string password, string endPointServicio = null)
        {
            ...
            EndPointServicio = string.IsNullOrEmpty(endPointServicio) ? "BillServicePort" : endPointServicio;
        ...
        public Tuple<string, bool> EnviarDocumento(string tramaArchivo, string nombreArchivo)
        {
            ...
            try
            {
                var ff = System.Text.Encoding.ASCII.GetBytes(tramaArchivo);
                var ss = Convert.ToBase64String(ff);
                _proxy.Open();
            ...
            {
                response = new Tuple<string, bool>(EndPointServicio == "BillServicePort"
